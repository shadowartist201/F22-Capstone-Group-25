...
namespace Game_Demo
{
    public class Game1 : Game
    {
        ...
        public static List<Item> inventory = new List<Item> { new Item("HP potion L", "Heals 50 HP"), new Item("Attack UP", "An attack booster"), new Item("Defense UP", "A defense booster") };
