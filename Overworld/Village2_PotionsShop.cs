...
namespace Game_Demo
{
    public class Village2_PotionsShop : GameScreen
    {
        private new Game1 Game => (Game1)base.Game;
        public Village2_PotionsShop(Game1 game) : base(game) { }

        private SpriteBatch _spriteBatch;
        private OrthographicCamera _camera;
        private EntityTest NPC1 = new(null, new Vector2(192, 336), false, false);
        ...
        public override void LoadContent()
        {
            ...
            Tiled.LoadMap("Village2_PotionsShop", Content, GraphicsDevice); //load map
