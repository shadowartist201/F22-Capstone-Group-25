...
namespace Game_Demo
{
    public class MountianEntrance : GameScreen
    {
        private new Game1 Game => (Game1)base.Game;
        public MountianEntrance(Game1 game) : base(game) { }

        private List<Item> chestinv = new List<Item> { new Item("Small potion", "Heals 20 health") };

        private SpriteBatch _spriteBatch;
        private OrthographicCamera _camera;
        private EntityTest NPC3 = new(null, new Vector2(504, 1008), false, false);
        ...
        public override void LoadContent()
        {
            ...
            Tiled.LoadMap("mountianentrance", Content, GraphicsDevice); //load map
