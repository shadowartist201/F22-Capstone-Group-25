...
namespace Game_Demo
{
    public class Village2_EquipShop : GameScreen
    {
        private new Game1 Game => (Game1)base.Game;
        public Village2_EquipShop(Game1 game) : base(game) { }

        private SpriteBatch _spriteBatch;
        private OrthographicCamera _camera;
        private EntityTest NPC1 = new(null, new Vector2(432, 240), false, false);
        ...
        public override void LoadContent()
        {
            ...
            Tiled.LoadMap("Village2_EquipShop", Content, GraphicsDevice); //load map
